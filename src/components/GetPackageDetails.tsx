...
const TrackPackageDetail = (props: any) => {
    
    console.log(props.package_no)
    const fetchData = () => { return axios.get(`http://170.187.252.177/api/v1/tracking/${props.package_no}`) }
...
export default TrackPackageDetail